...
zypper:
  repositories:
    openSUSE:infrastructure:
      baseurl: http://$mirror_int/repositories/openSUSE:/infrastructure/{{ leap_equivalent }}/
      gpgautoimport: True
      priority: 100
      refresh: True
    openSUSE:infrastructure:Micro:
      baseurl: http://$mirror_int/repositories/openSUSE:/infrastructure:/Micro/Micro_{{ grains['osrelease'] }}/
      gpgautoimport: True
      priority: 98
      refresh: True
{%- else %}
