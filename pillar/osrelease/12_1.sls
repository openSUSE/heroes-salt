...
{% if 'ha' in roles %}
    SLE-HA-POOL:
      baseurl: http://download.nue.suse.com/ibs/SUSE/Products/SLE-HA/12-SP1/x86_64/product
      priority: 99
      refresh: True
    SLE-HA-UPDATES:
      baseurl: http://download.nue.suse.com/ibs/SUSE/Updates/SLE-HA/12-SP1/x86_64/update
      priority: 99
      refresh: True
{% endif %}
