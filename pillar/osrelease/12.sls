zypper:
  repositories:
    SLE-HA:
      baseurl: http://smt-internal.infra.opensuse.org/repo/$RCE/SUSE/Products/SLE-HA/12/x86_64/product
      priority: 99
      refresh: False
    SLE-HA-Update:
      baseurl: http://smt-internal.infra.opensuse.org/repo/$RCE/SUSE/Updates/SLE-HA/12/x86_64/update
      priority: 99
      refresh: True
    ...
    SLE-Module-Web-Scripting-Update:
      ...
      refresh: True
    SLE-SDK:
      baseurl: http://smt-internal.infra.opensuse.org/repo/$RCE/SUSE/Products/SLE-SDK/121/x86_64/product
      priority: 99
      refresh: False
    SLE-SDK-Update:
      baseurl: http://smt-internal.infra.opensuse.org/repo/$RCE/SUSE/Updates/SLE-SDK/12/x86_64/update
      priority: 99
      refresh: True
    SLE-SERVER:
      baseurl: http://smt-internal.infra.opensuse.org/repo/$RCE/SUSE/Products/SLE-SERVER/12/x86_64/product
      priority: 99
      refresh: False
    SLE-SERVER-Update:
