  ...
  fencing:
    ...
    sbd:
      devices:
        ...
        - /dev/disk/by-id/scsi-3600a09803831494f635d554b394f766c
        {#- /vol/lun_falkor_fencing2/sbd1002 #}
        - /dev/disk/by-id/scsi-3600a09803831494c775d554b39507472
        {#- /vol/lun_falkor_fencing3/sbd1003 #}
        - /dev/disk/by-id/scsi-3600a09803831494f635d554b394f766e
      instances:
        {%- for i in [0, 1, 2] %}
        {%- set node = 'falkor' ~ i %}
        {{ node }}:
